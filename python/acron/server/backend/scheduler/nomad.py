...
#
'''Implementation of the Nomad backend client'''

from acron.exceptions import NomadError
...
class Nomad(Scheduler):
    '''
    Implements a scheduler based on Hashicorp's Nomad software.
    '''
    ...
    def backend_status(config):
        ...
        :raises NomadError: on unexpected backend error
